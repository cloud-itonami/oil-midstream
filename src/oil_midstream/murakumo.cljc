...
(defn collection
  [name]
  (str "com.etzhayyim.oil-midstream." name))

(def cell-specs {
  :getpipeline {:legacy-cell "com-etzhayyim-apps-oilMidstream-infrastructure-getPipeline"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getpipeline")]
     :required-gates common-gates
     :trigger "manifest cell getpipeline"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listpipelines {:legacy-cell "com-etzhayyim-apps-oilMidstream-infrastructure-listPipelines"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listpipelines")]
     :required-gates common-gates
     :trigger "manifest cell listpipelines"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listterminals {:legacy-cell "com-etzhayyim-apps-oilMidstream-infrastructure-listTerminals"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listterminals")]
     :required-gates common-gates
     :trigger "manifest cell listterminals"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getterminalnetwork {:legacy-cell "com-etzhayyim-apps-oilMidstream-infrastructure-getTerminalNetwork"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getterminalnetwork")]
     :required-gates common-gates
     :trigger "manifest cell getterminalnetwork"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :health {:legacy-cell "com-etzhayyim-apps-oilMidstream-health"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :pipeline {:legacy-cell "com-etzhayyim-apps-oilMidstream-pipeline"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "pipeline")]
     :required-gates common-gates
     :trigger "manifest cell pipeline"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :terminal {:legacy-cell "com-etzhayyim-apps-oilMidstream-terminal"
     :phase :event
     :murakumo-node "reuben"
